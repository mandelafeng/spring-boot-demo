...
public class BeanUtils {
    ...
    private static <T> T pojoConvert(Object sourceEntity, Class<T> targetClass, String... ignoreProperties) {
        ...
        if (ignoreProperties.length > 0) {
            org.springframework.beans.BeanUtils.copyProperties(sourceEntity, targetInstance, ignoreProperties);
        } else {
            org.springframework.beans.BeanUtils.copyProperties(sourceEntity, targetInstance);
        }
