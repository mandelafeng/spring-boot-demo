 ...
 */
@Slf4j
public class SceneRepositoryTest extends SpringBootDemoElasticsearchApplicationTests {
    @Autowired
    ...
    public void save() {
        ...
        sceneInfo.setId(1L);
        sceneInfo.setSceneName("es-test");
        sceneInfo.setTag("直到");
        sceneInfo.setSceneDesc("2233");
        sceneInfo.setSupplier("镝石");
        sceneInfo.setUpdateTime("2023-02-07");
        SceneInfo save = repo.save(sceneInfo);
        log.info("【save】= {}", save);
    }
